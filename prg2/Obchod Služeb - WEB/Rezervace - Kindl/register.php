 				...
 				<?php 
						if(isset($_POST['submit'])){
							...
							}else
							{
								...
								$pass = md5($pass1);
								$sql = '
									INSERT INTO tourist(tour_fN, tour_lN, tour_address, tour_contact, tour_un, tour_up, user_type)
									VALUES(?,?,?,?,?,?, 2);
								';
				  ...
				  <div class="panel-heading">Registrace</div>
					  <div class="panel-body">
						 <form action="" method="post">
							...
							<div class="form-group">
							 	 <label for="cont">tel.cislo #:</label>
							...
							<div class="form-group">
							 	 <label for="uN">prihlasovaci jmeno:</label>
