    ...
    class tsin
    {
        ...
        public string ts(double x)
        {
            ...
            while (true)
            {
                ...
                answer += (Math.Pow(-1, k) / Factorial(2 * k + 1)) * Math.Pow(x, 2 * k + 1);
        ...
        public string ts(double x, int a)
        {
            // Holds and returns final answer
            double answer = 0;
